...
?>
        ...
        <div class="d-flex">
            ...
            <div class="admin-list2" style="background-color:pink;">
                ...
                <table class="table bg-light table-bordered border-5 border-dark">
                        <thead>
                        <tr>
                    ...
                    <?php
                         ...
                         while($row = mysqli_fetch_assoc($query)){
                              ...
                              echo " <tr>
                              <td>
                                  <h6><b>{$row['Doctor_Name']}</b> </h6>
                              </td>
                              <td>
                                    <h6><b>{$row['Customer_Name']}</b></h6>
                              ...
                              <td>
                                  <a href='../deleteAppointment.php?id={$row['Aid']}' class='btn btn-danger' name='delete' >Delete</a>
